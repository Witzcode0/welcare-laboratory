...
SECRET_KEY = 'django-insecure-(@^=t4lp$!y9h52%1d4&xtsnir@8&*w5-#lm^ca4@4$l(_pvf3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'authenticate.context_processors.authenticated_employee'
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = 'dgjqikebxamvqhbj'  